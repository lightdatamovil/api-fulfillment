...
productos.put(
  ...
  buildHandlerWrapper({
    requiredParams: ["did"],
    optional: ["did_cliente", "titulo", "descripcion", "habilitado", "es_combo", "posicion", "cm3", "alto", "ancho", "profundo", "files", "sku", "ean", "did_curva", "insumos", "combinaciones", "productos_hijos", "dids_ie"],
