 ...
 * @param {string[]} [opts.requiredParams=[]]
...
export function buildHandler({
    ...
    return async (req, res) => {
        ...
        try {
            ...
            verifyAll(req, requiredParams, { required, optional });
            ...
            if (needsDb) {
                const dbConfig = getFFProductionDbConfig(company, hostProductionDb, portProductionDb);
