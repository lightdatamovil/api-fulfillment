...
class Insumo {
  ...
  async createNewRecord(connection) {
    try {
      const querycheck =
        "SELECT codigo FROM insumos WHERE codigo = ? and superado = 0 and elim = 0";
      ...
      const insertQuery = `INSERT INTO insumos (${filteredColumns.join(
        ", "
  ...
  async delete(connection, did) {
    try {
      const deleteQuery =
        "UPDATE insumos SET elim = 1 WHERE did = ? AND superado = 0";
